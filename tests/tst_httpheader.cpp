...
class tst_HttpHeader : public QObject
{
	Q_OBJECT
...
private slots:
	...
	// HttpHeaderCollectionTest methods
	void collection_should_be_initially_blank()
	{
	...
	void collection_should_be_a_vector_of_http_headers()
	{
		Pillow::HttpHeaderCollection c;
	...
	void collection_should_allow_adding_headers()
	{
	...
	void collection_should_allow_inserting_raw_headers_literals()
	{
		Pillow::HttpHeaderCollection c;
	...
	void collection_should_be_a_vector_of_bytearray_pairs()
	{
	...
	void collection_should_allow_finding_field_value_case_insensitively()
	{
		Pillow::HttpHeaderCollection c;
	...
	void collection_should_allow_finding_multiple_field_values_case_insensitively()
	{
		Pillow::HttpHeaderCollection c;
	...
	void collection_benchmark_getFieldValue()
	{
		Pillow::HttpHeaderCollection c;
		c << "Some-Field: some/value"
		  << "ANOTHER-FIELD: ANOTHER/VALUE"
	...
	void collection_should_allow_testing_whether_the_specified_field_has_the_specified_value_in_any_header_case_insensitively()
	{
		Pillow::HttpHeaderCollection c;
		c << "A: Hello"
		  << "B: World"
	...
	void collection_benchmark_testFieldValue()
	{
		Pillow::HttpHeaderCollection c;
		c << "Some-Field: some/value"
		  << "ANOTHER-FIELD: ANOTHER/VALUE"
...
QTEST_MAIN(tst_HttpHeader)
#include "tst_httpheader.moc"
