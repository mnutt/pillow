...
{
	connection->writeResponseString(404, HttpHeaderCollection(), QString("The requested resource does not exist on this server"));
	return true;
}
...
bool HttpHandlerFile::handleRequest(Pillow::HttpConnection *connection)
{
	...
	if (!file->open(QIODevice::ReadOnly))
	{
		...
		connection->writeResponse(403, HttpHeaderCollection(), QString("The requested resource is not accessible"));
		delete file;
	}
	else
	{
